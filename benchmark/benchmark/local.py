...
class LocalBench:
    ...
    def run(self, debug=False):
        ...
        try:
            ...
            return LogParser.process('./logs', self.faults, self.node_parameters.protocol, self.node_parameters.ddos, self.node_parameters.random_ddos, self.node_parameters.ddos_chance)
